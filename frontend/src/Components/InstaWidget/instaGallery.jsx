    ...
    InstaBodyError = () => {
        ...
        return(
            <div className={cssInstagram.instaNotVisibleCenter}>
                <a href={`https://www.instagram.com/${userName}/`} rel="noopener noreferrer nofollow" target="_blank"><img alt={`Follow Me: @${userName}`} src="/images/instagramNotVisible.jpg"/></a>
            </div>
        )
    }
