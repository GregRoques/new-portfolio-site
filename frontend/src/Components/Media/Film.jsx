...
class Film extends Component{
    ...
    render(){
        ...
        return(
            <div>
                <div className={cssFilm.artDirection}>Video</div>
                ...
                <iframe title="GR Videos" width="560" height="315" src={videoLinks[currVid].video} frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
                </div>
